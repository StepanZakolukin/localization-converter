...
public class ResxLocalizationWriter(string directoryPath) : ILocalizationWriter
{
    ...
    private XElement CreateXmlRoot()
    {
        return new XElement(ResxConstants.Nodes.Root,
            ...
            new XElement(
                ResxConstants.Nodes.Header,
                new XAttribute(ResxConstants.Nodes.NameAttribute, ResxConstants.Keys.Version),
            ...
            new XElement(
                ResxConstants.Nodes.Header,
                new XAttribute(ResxConstants.Nodes.NameAttribute, ResxConstants.Keys.Writer),
                new XElement(ResxConstants.Nodes.Value, ResxConstants.Values.WriterType)
            )
        );
    }

    private XElement CreateDataElement(Localization localization)
    {
        return new XElement(ResxConstants.Nodes.Data,
